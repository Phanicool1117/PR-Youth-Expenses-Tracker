...
import { User, Lock, Eye, EyeOff, Info, ArrowRight, Loader2, CheckCircle2 } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#dcebfa] via-[#edf5fc] to-[#f5f9fd] flex items-center justify-center p-4 sm:p-6">
      <div className="w-full max-w-md mx-auto my-auto py-6">
        {/* Shadcn Glassmorphic Login Card */}
        <div className="bg-gradient-to-b from-[#ebf5ff] via-white to-white border border-white/90 rounded-[28px] p-7 sm:p-9 shadow-2xl shadow-blue-500/10 backdrop-blur-md space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 pt-1">
            ...
            {/* Interactive Primary Action Button with Loading & Green Tick Confirmation */}
            <button
              type="submit"
              disabled={isSubmitting || isSuccessState}
              className={`w-full py-3.5 rounded-2xl shadow-md transition-all duration-300 font-bold text-sm flex items-center justify-center gap-2 mt-4 active:scale-[0.99] ${
                isSuccessState
