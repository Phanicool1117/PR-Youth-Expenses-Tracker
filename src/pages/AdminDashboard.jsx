      ...
      <div className="reference-card rounded-3xl overflow-hidden bg-gradient-to-br from-white via-slate-50/50 to-white shadow-sm border border-slate-200 transition-all">
        ...
        >
          <div className="space-y-1 w-full sm:w-auto">
            ...
            {/* Net Committee Balance Label & Side Pathway Quick Indicators */}
            <div className="flex items-center gap-2 flex-wrap pt-0.5">
              ...
              <div className="flex items-center gap-1.5 text-[10.5px] font-bold flex-wrap">
                <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full bg-blue-50 text-[#0f52ba] border border-blue-200">
                  <Globe className="w-3 h-3 text-[#0f52ba]" />
                  <span>Online: ₹{paymentPathways.netOnline.toLocaleString('en-IN')}</span>
                </span>
                <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full bg-emerald-50 text-emerald-700 border border-emerald-200">
                  ...
                  <span>Cash: ₹{paymentPathways.netCash.toLocaleString('en-IN')}</span>
                </span>
              </div>
            </div>
          </div>
